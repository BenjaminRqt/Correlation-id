...
class CorrelationIdSubscriber implements EventSubscriberInterface
{
    ...
    {
        $event->getRequest()->attributes->set($this->requestHeaderName, CorrelationId::generate()->getId());
    }
    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        $event->getResponse()->headers->set($this->responseHeaderName, CorrelationID::generate()->getId());
    }
